...
class UserAddress(models.Model):
    ...
    """
    user = models.ForeignKey(User,  on_delete=models.CASCADE, verbose_name="用户")
    province = models.CharField(help_text="省份", max_length=100, default="")
    city = models.CharField(help_text="城市", max_length=100, default="")
    district = models.CharField(help_text="区域", max_length=100, default="")
