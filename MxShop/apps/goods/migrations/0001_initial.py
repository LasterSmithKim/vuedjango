# Generated by Django 2.2.7 on 2019-11-26 14:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_front_image', models.ImageField(blank=True, null=True, upload_to='', verbose_name='商品封面')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('parent_category', models.ForeignKey(blank=True, null=True, on_delete=((1, '一级类目'), (2, '二级类目'), (3, '三级类目')), related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父类别')),
            ],
            options={
                'verbose_name': '商品类别',
